...
Ce CV est une traduction de mon CV, originalement pensé pour être écrit en anglais

Il est basé sur le template AltaCV
J'ai conservé les commandes cvtag et cvsection de altacv
J'ai ajouté la librairie smartdiagrams (visible dans les compétences)
J'ai utilisé une combinaison de cvtag et de la
